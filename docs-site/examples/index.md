...
| [example-rest-mongodb](https://github.com/sprakas/banana-universe/tree/main/apps/example-rest-mongodb)       | Prisma + MongoDB     | Document model, `@ZodBody` validation (see README for connector limits)    |
