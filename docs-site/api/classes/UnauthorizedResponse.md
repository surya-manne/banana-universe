...
[@banana-universe/bananajs](../README.md) / UnauthorizedResponse

# Class: UnauthorizedResponse

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:91
...
> **new UnauthorizedResponse**(`message?`): `UnauthorizedResponse`

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:97
...
A descriptive message accompanying the response. Defaults to 'Unauthorized'.
