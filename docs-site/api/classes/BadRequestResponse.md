...
[@banana-universe/bananajs](../README.md) / BadRequestResponse

# Class: BadRequestResponse

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:80
...
> **new BadRequestResponse**(`message?`): `BadRequestResponse`

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:86
...
A descriptive message accompanying the response. Defaults to 'Bad Parameters'.
