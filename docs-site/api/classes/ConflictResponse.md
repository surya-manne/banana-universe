...
[@banana-universe/bananajs](../README.md) / ConflictResponse

# Class: ConflictResponse

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:136
...
> **new ConflictResponse**(`message?`): `ConflictResponse`

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:142
...
A descriptive message accompanying the response. Defaults to 'Conflict'.
