...
[@banana-universe/bananajs](../README.md) / BadRequestError

# Class: BadRequestError

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:69
...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:75
...
A descriptive message accompanying the error. Defaults to 'Bad Request'.
