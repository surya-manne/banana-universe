...
[@banana-universe/bananajs](../README.md) / NotFoundError

# Class: NotFoundError

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:113
...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:119
...
A descriptive message accompanying the error. Defaults to 'Not Found'.
