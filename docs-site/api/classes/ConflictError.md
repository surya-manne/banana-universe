...
[@banana-universe/bananajs](../README.md) / ConflictError

# Class: ConflictError

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:124
...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:130
...
A descriptive message accompanying the error. Defaults to 'Conflict'.
