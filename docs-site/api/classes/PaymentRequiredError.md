...
[@banana-universe/bananajs](../README.md) / PaymentRequiredError

# Class: PaymentRequiredError

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:91
...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:97
...
A descriptive message accompanying the error. Defaults to 'Payment Required'.
