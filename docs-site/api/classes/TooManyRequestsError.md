...
[@banana-universe/bananajs](../README.md) / TooManyRequestsError

# Class: TooManyRequestsError

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:135
...
> **new TooManyRequestsError**(`message?`): `TooManyRequestsError`

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:141
...
A descriptive message accompanying the error. Defaults to 'Too Many Requests'.
