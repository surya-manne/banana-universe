...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:179
...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:185
...
A descriptive message accompanying the error. Defaults to 'Gateway Timeout'.
