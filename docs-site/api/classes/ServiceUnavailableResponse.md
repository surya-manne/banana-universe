...
[@banana-universe/bananajs](../README.md) / ServiceUnavailableResponse

# Class: ServiceUnavailableResponse

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:181
...
> **new ServiceUnavailableResponse**(`message?`): `ServiceUnavailableResponse`

Defined in: packages/bananajs/src/lib/Response/ApiResponse.ts:187
...
A descriptive message accompanying the response. Defaults to 'Service Unavailable'.
