...
[@banana-universe/bananajs](../README.md) / ForbiddenError

# Class: ForbiddenError

Defined in: packages/bananajs/src/lib/Response/ApiError.ts:102
...
Defined in: packages/bananajs/src/lib/Response/ApiError.ts:108
...
A descriptive message accompanying the error. Defaults to 'Forbidden'.
